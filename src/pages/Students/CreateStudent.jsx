          ...
          <div className="mb-[20px] flex flex-col justify-center mx-[20px]">
            ...
            <div className="flex justify-center items-center">
              ...
              >
                ...
                />
                <label className="font-[400] text-[11px]" htmlFor="create_students_1">
                  VD: Nguyen Van A
                </label>
              </div>
              ...
              >
                ...
                />
                <label className="font-[400] text-[11px]" htmlFor="create_students_2">
                  VD: 0389960079
                </label>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center">
              ...
              >
                ...
                />
                <label className="font-[400] text-[11px]" htmlFor="create_students_3">
              ...
              >
                ...
                <label className="font-[400] text-[11px]" htmlFor="create_students_4">
                  Vui lòng chọn lớp
                </label>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center">
              ...
              >
                ...
                />
                <label className="font-[400] text-[11px]" htmlFor="create_students_5">
                  VD: 12345678
                </label>
              </div>
              <div
              ...
              >
                ...
                />
                <label className="font-[400] text-[11px]" htmlFor="create_students_6">
